...
export const HeroVideoDialog: React.FC<HeroVideoDialogProps> = ({
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <motion.div
            ...
            className="p-4 rounded bg-linear-to-r from-primary to-secondary shadow-[0_0_20px_rgba(59,130,246,0.6)]"
          >
            <Play
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex items-center justify-center bg-linear-to-br from-primary to-secondary bg-opacity-75 backdrop-blur-lg"
          >
            <motion.div
              {...selectedAnimation}
            ...
            >
              ...
              <motion.button
                ...
                className="absolute -top-10 right-0 text-primary text-2xl bg-muted/70 ring-2 ring-primary backdrop-blur-xs rounded p-3 z-10"
              >
              ...
              <div className="relative w-full h-full rounded-xl overflow-hidden">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-linear-to-r from-transparent via-muted/10 to-transparent pointer-events-none"
                ></motion.div>
              </div>
            </motion.div>
          </motion.div>
